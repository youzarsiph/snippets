...
const Constants = {
  ...
  colors: [
    "bg-blue-500 from-blue-500 to-blue-300 ring-1 ring-blue-500 dark:bg-blue-800 dark:from-blue-950 dark:to-blue-700 dark:ring-blue-950",
    "bg-green-500 from-green-500 to-green-300 ring-1 ring-green-500 dark:bg-green-800 dark:from-green-950 dark:to-green-700 dark:ring-green-950",
    "bg-rose-500 from-rose-500 to-rose-300 ring-1 ring-rose-500 dark:bg-rose-800 dark:from-rose-950 dark:to-rose-700 dark:ring-rose-950",
    "bg-indigo-500 from-indigo-500 to-indigo-300 ring-1 ring-indigo-500 dark:bg-indigo-800 dark:from-indigo-950 dark:to-indigo-700 dark:ring-indigo-950",
    "bg-violet-500 from-violet-500 to-violet-300 ring-1 ring-violet-500 dark:bg-violet-800 dark:from-violet-950 dark:to-violet-700 dark:ring-violet-950",
    "bg-purple-500 from-purple-500 to-purple-300 ring-1 ring-purple-500 dark:bg-purple-800 dark:from-purple-950 dark:to-purple-700 dark:ring-purple-950",
    "bg-lime-500 from-lime-500 to-lime-300 ring-1 ring-lime-500 dark:bg-lime-800 dark:from-lime-950 dark:to-lime-700 dark:ring-lime-950",
    "bg-yellow-500 from-yellow-500 to-yellow-300 ring-1 ring-yellow-500 dark:bg-yellow-800 dark:from-yellow-950 dark:to-yellow-700 dark:ring-yellow-950",
    "bg-sky-500 from-sky-500 to-sky-300 ring-1 ring-sky-500 dark:bg-sky-800 dark:from-sky-950 dark:to-sky-700 dark:ring-sky-950",
    "bg-teal-500 from-teal-500 to-teal-300 ring-1 ring-teal-500 dark:bg-teal-800 dark:from-teal-950 dark:to-teal-700 dark:ring-teal-950",
    "bg-cyan-500 from-cyan-500 to-cyan-300 ring-1 ring-cyan-500 dark:bg-cyan-800 dark:from-cyan-950 dark:to-cyan-700 dark:ring-cyan-950",
    "bg-amber-500 from-amber-500 to-amber-300 ring-1 ring-amber-500 dark:bg-amber-800 dark:from-amber-950 dark:to-amber-700 dark:ring-amber-950",
    "bg-emerald-500 from-emerald-500 to-emerald-300 ring-1 ring-emerald-500 dark:bg-emerald-800 dark:from-emerald-950 dark:to-emerald-700 dark:ring-emerald-950",
    ...
    "bg-green-400 from-green-400 to-teal-400 ring-1 ring-green-400 dark:bg-green-800 dark:from-green-700 dark:to-teal-600 dark:ring-green-700",
    "bg-green-400 from-green-400 to-amber-300 ring-1 ring-green-400 dark:bg-green-800 dark:from-green-700 dark:to-amber-600 dark:ring-green-700",
    "bg-sky-300 from-sky-300 to-pink-300 ring-1 ring-sky-300 dark:bg-sky-800 dark:from-sky-700 dark:to-pink-600 dark:ring-sky-700",
    "bg-green-400 from-green-400 to-sky-400 ring-1 ring-green-400 dark:bg-green-800 dark:from-green-600 dark:to-sky-500 dark:ring-green-600",
    "bg-emerald-400 from-emerald-400 to-sky-300 ring-1 ring-emerald-400 dark:bg-emerald-800 dark:from-emerald-700 dark:to-sky-600 dark:ring-emerald-700",
    "bg-lime-300 from-lime-300 to-green-400 ring-1 ring-lime-300 dark:bg-lime-800 dark:from-lime-700 dark:to-green-600 dark:ring-lime-700",
    "bg-cyan-300 from-cyan-300 to-emerald-400 ring-1 ring-cyan-300 dark:bg-cyan-800 dark:from-cyan-800 dark:to-emerald-700 dark:ring-cyan-800",
    "bg-cyan-200 from-cyan-200 to-pink-400 ring-1 ring-cyan-200 dark:bg-cyan-800 dark:from-cyan-700 dark:to-pink-600 dark:ring-cyan-700",
    "bg-red-400 from-red-400 to-orange-300 ring-1 ring-red-400 dark:bg-red-800 dark:from-red-600 dark:to-orange-500 dark:ring-red-600",
    "bg-orange-400 from-orange-400 to-orange-100 ring-1 ring-orange-400 dark:bg-red-800 dark:from-red-700 dark:to-red-600 dark:ring-red-700",
    "bg-orange-200 from-orange-200 to-sky-400 ring-1 ring-orange-200 dark:bg-orange-800 dark:from-orange-800 dark:to-sky-700 dark:ring-orange-800",
    "bg-orange-200 from-orange-200 to-red-300 ring-1 ring-orange-200 dark:bg-orange-800 dark:from-orange-600 dark:to-red-500 dark:ring-orange-600",
    "bg-lime-200 from-lime-200 to-pink-400 ring-1 ring-lime-200 dark:bg-lime-800 dark:from-lime-600 dark:to-pink-500 dark:ring-lime-600",
    "bg-sky-200 from-sky-200 to-pink-300 ring-1 ring-sky-200 dark:bg-sky-800 dark:from-sky-600 dark:to-pink-500 dark:ring-sky-600",
  ],
  highlights: [
    "a11y-dark",
    "a11y-dark.min",
