    ...
    >
      ...
      <div className="fixed inset-x-0 bottom-0 flex items-center justify-center lg:inset-y-0">
        <div className="flex items-center justify-center p-4 text-center">
          ...
          >
            <Dialog.Panel className="relative grid max-h-[40rem] w-full transform gap-6 overflow-hidden overflow-y-auto rounded-2xl rounded-t-3xl bg-white bg-white/80 p-6 text-left align-middle shadow-xl ring-1 ring-white transition-all lg:inset-x-auto lg:max-h-[45rem] lg:min-w-[30rem] lg:max-w-md lg:rounded-3xl dark:bg-slate-800/75 dark:ring-slate-900">
