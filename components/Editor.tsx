      ...
      <nav className={"editor-nav"}>
        <div className={"editor-bar"}>
          <div className="flex items-center gap-4">
            ...
            <h1 className={"editor-brand"}>Snippets</h1>
          </div>
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="group relative">
                <button
                  type="button"
                  className={
                    "editor-menu group peer relative flex items-center justify-center"
                  }
                >
                ...
                <ul className={"editor-list md:min-w-[30rem]"}>
              ...
              <div title="Export" className="relative">
                <button type="button" className={"editor-menu peer"}>
                  <DocumentArrowDownIcon className="h-6 w-6" />
                </button>

                <ul className={"editor-list"}>
                  {Constants.formats.map((i) => (
                    <li key={i} className={"editor-list-item"}>
                      <button
                        type="button"
